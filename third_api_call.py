import os
import time
import requests  # NEW: 我们现在只使用 requests 库
...
# 系统指令，用于设定AI的角色和总体任务,自己可以改改具体内容
#   ！！！！！！！！！！！！请替换下面【】里的名字！！！！！！！！！！！！
SYSTEM_PROMPT = """
...
def process_single_file(filename):
    ...
    try:
        ...
        headers = {
            ...
            "Authorization": f"Bearer {API_KEY}"  # 自动添加 "Bearer " 前缀
        }
